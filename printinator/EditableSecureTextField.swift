...
struct EditableSecureTextField: NSViewRepresentable {
    let placeholder: String
    @Binding var text: String
    let onCommit: () -> Void
    
    func makeNSView(context: Context) -> EditableNSSecureTextField {
        let textField = EditableNSSecureTextField()
    ...
    class Coordinator: NSObject, NSTextFieldDelegate {
            let parent: EditableSecureTextField

            init(_ textField: EditableSecureTextField) {
